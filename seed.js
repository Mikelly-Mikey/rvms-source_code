...
async function seed() {
  try {
    ...
    console.log(
      "✅ Users created (admin=1, fleet=2, reception=3, mechanic=4, mwangi=5, shiks100=6)",
    );
    ...
    const v1 = await Vehicle.create({
      ...
      image_url: "/images/mazda-axela2.jpeg",
    });
    const v2 = await Vehicle.create({
      registration: "KBT 027F",
      make: "Mazda",
      model: "Axela",
      year: 2016,
      color: "Dark Tan",
      ...
      weekly_rate: 16800,
      status: "on-rent",
      current_mileage: 34590,
      image_url: "/images/mazda-axela3.jpeg",
    });
    const v3 = await Vehicle.create({
      registration: "KCB 234B",
      make: "Nissan",
      model: "Note",
      year: 2019,
      color: "Silver",
      ...
      image_url: "/images/nissan-note.jpeg",
    });
    const v4 = await Vehicle.create({
      registration: "KCC 345C",
      make: "Toyota",
      model: "Rav4",
      year: 2020,
      color: "Black",
      ...
      image_url: "/images/toyota-RAV4.jpeg",
    });
    const v5 = await Vehicle.create({
      registration: "KCD 456D",
      make: "Mitsubishi",
      model: "Outlander",
      year: 2019,
      color: "Brown",
      ...
      image_url: "/images/mitsubishi-outlander_SEL.jpeg",
    });
    const v6 = await Vehicle.create({
      registration: "KCE 567E",
      make: "Mercedes",
      model: "C200",
      year: 2021,
      color: "Grey",
      ...
      image_url: "/images/benz_c-class.jpeg",
    });
    const v7 = await Vehicle.create({
      registration: "KCW 678F",
      make: "Toyota",
      model: "Hilux",
      year: 2019,
      color: "Silver",
      ...
      image_url: "/images/toyota-hilux.jpeg",
    });
    const v8 = await Vehicle.create({
      registration: "KCG 789G",
      make: "Subaru",
      model: "Forester",
      year: 2020,
      color: "Black",
      ...
      image_url: "/images/subaru-forester3.jpeg",
    });
    const v9 = await Vehicle.create({
      registration: "KCH 890H",
      make: "Honda",
      model: "Fit",
      year: 2018,
      color: "Orange",
      ...
      weekly_rate: 16800,
      status: "on-rent",
      current_mileage: 83000,
      image_url: "/images/honda-fit2.jpeg",
    });
    const v10 = await Vehicle.create({
      registration: "KCJ 901I",
      make: "Toyota",
      model: "Hilux",
      year: 2021,
      color: "White",
      ...
      image_url: "/images/toyota-hilux2.jpeg",
    });
    const v11 = await Vehicle.create({
      registration: "KCK 012J",
      make: "Nissan",
      model: "X-Trail",
      year: 2020,
      color: "Black",
      ...
      image_url: "/images/nissan-xtrail.jpeg",
    });
    const v12 = await Vehicle.create({
      registration: "KCL 141K",
      make: "Toyota",
      model: "Probox",
      year: 2016,
      color: "White",
      ...
      image_url: "/images/probox(toyota).jpeg",
    });
    const v13 = await Vehicle.create({
      registration: "KCA 284N",
      make: "Toyota",
      model: "Probox",
      year: 2019,
      color: "Gray",
      ...
      status: "available",
      current_mileage: 140000,
      image_url: "/images/toyota-probox.jpeg",
    });
    const v14 = await Vehicle.create({
      registration: "KCM 292L",
      make: "Mazda",
      model: "Demio",
      year: 2019,
      color: "White",
      ...
      image_url: "/images/mazda-demio.jpeg",
    });
    const v15 = await Vehicle.create({
      registration: "KCN 373M",
      make: "Toyota",
      model: "Fielder",
      year: 2018,
      color: "Grey",
      ...
      image_url: "/images/toyota-fielder1.jpeg",
    });
    const v16 = await Vehicle.create({
      registration: "KDG 106M",
      make: "Toyota",
      model: "Fielder",
      year: 2024,
      color: "Black",
      ...
      weekly_rate: 21000,
      status: "on-rent",
      current_mileage: 80085,
      image_url: "/images/toyota-fielder3.jpeg",
    });
    const v17 = await Vehicle.create({
      registration: "KCO 404N",
      make: "Isuzu",
      model: "D-Max",
      year: 2022,
      color: "White",
      ...
      image_url: "/images/d-max.jpeg",
    });
    const v18 = await Vehicle.create({
      registration: "KCP 545T",
      make: "BMW",
      model: "X3",
      year: 2021,
      color: "Black",
      ...
      image_url: "/images/bmw_x3.jpeg",
    });
    const v19 = await Vehicle.create({
      registration: "KCQ 616P",
      make: "Suzuki",
      model: "Swift",
      year: 2020,
      color: "Red-Orange",
      ...
      image_url: "/images/suzuki_swift2.jpeg",
    });
    const v20 = await Vehicle.create({
      registration: "KCR 770Q",
      make: "Volkswagen",
      model: "Polo",
      year: 2019,
      color: "Navy-Blue",
      ...
      image_url: "/images/vw-polo1.jpeg",
    });
    const v21 = await Vehicle.create({
      registration: "KCS 588R",
      make: "Hyundai",
      model: "Tucson",
      year: 2022,
      color: "Blue",
      ...
      image_url: "/images/hyundai_tucson1.jpeg",
    });
    const v22 = await Vehicle.create({
      registration: "KCT 929S",
      make: "Toyota",
      model: "Land Cruiser",
      year: 2021,
      color: "White",
    ...
    const v23 = await Vehicle.create({
      registration: "KCU 101T",
      make: "Mitsubishi",
      model: "Outlander Phev LS",
      year: 2020,
      color: "Black",
      fuel_type: "diesel",
      transmission: "manual",
      ...
      image_url: "/images/MITSUBISHI-OUTLANDER_phev_ls.jpeg",
    });
    const v24 = await Vehicle.create({
      registration: "KDA 947K",
      make: "BMW",
      model: "AMG",
      year: 2025,
      color: "Black",
      ...
      weekly_rate: 60000,
      status: "available",
      current_mileage: 10936,
      image_url: "/images/bmw.jpeg",
    });
    const v25 = await Vehicle.create({
      registration: "KCZ 792S",
      make: "BMW",
      model: "X3",
      year: 2024,
      color: "Red",
      ...
      weekly_rate: 90000,
      status: "available",
      current_mileage: 18030,
      image_url: "/images/bmw_x3-1.jpeg",
    });
    const v26 = await Vehicle.create({
      registration: "KCH 604L",
      make: "Toyota",
      model: "Land Cruiser",
      year: 2022,
      color: "Slate",
      ...
      weekly_rate: 108000,
      status: "available",
      current_mileage: 22042,
      image_url: "/images/landcruiser- prado( toyota).jpeg",
    });
    ...
    const c1 = await Customer.create({
      ...
      registered_by: bookingOfficer.id,
    });
    ...
    const c5 = await Customer.create({
      ...
      id_type: "national_id",
      id_number: "99001122",
      license_number: "DL345661",
      license_expiry: "2026-11-05",
      registered_by: bookingOfficer.id,
    });
    ...
    const c6 = await Customer.create({
      ...
      id_type: "national_id",
      id_number: "33445566",
      license_number: "DL789020",
      license_expiry: "2027-01-12",
      registered_by: bookingOfficer.id,
    });
    const c7 = await Customer.create({
      ...
      id_type: "passport",
      id_number: "P11223",
      license_number: "DL012395",
      license_expiry: "2026-09-30",
      registered_by: bookingOfficer.id,
    });
    const c8 = await Customer.create({
      first_name: "Grace",
      last_name: "Wanjiku",
      phone: "+254789012345",
      email: "shikuG@email.com",
    ...
    const c9 = await Customer.create({
      first_name: "Patrick",
      last_name: "Mutua",
      phone: "+254701234567",
      ...
      id_type: "national_id",
      id_number: "22334455",
      license_number: "DL890165",
      license_expiry: "2027-07-22",
      registered_by: bookingOfficer.id,
    });
    const c10 = await Customer.create({
      first_name: "Joyce",
      last_name: "Chebet",
      phone: "+254712345000",
    ...
    const b1 = await Booking.create({
      ...
      start_date: subDays(today, 19),
      end_date: subDays(today, 15),
      pickup_time: "10:00",
      return_time: "10:00",
      status: "completed",
      total_amount: 12500,
      deposit_paid: 12500,
      balance_due: 0,
      actual_pickup_time: subDays(today, 19),
      actual_return_time: subDays(today, 15),
      check_out_mileage: 77000,
      check_in_mileage: 77800,
      check_out_fuel: 80,
      check_in_fuel: 40,
    });
    ...
    const b2 = await Booking.create({
      ...
      created_by: bookingOfficer.id,
      start_date: subDays(today, 13),
      end_date: subDays(today, 10),
      pickup_time: "09:00",
      return_time: "09:00",
      status: "completed",
      total_amount: 12000,
      deposit_paid: 12000,
      balance_due: 0,
      actual_pickup_time: subDays(today, 13),
      actual_return_time: subDays(today, 10),
      check_out_mileage: 55000,
      check_in_mileage: 55600,
      check_out_fuel: 100,
      check_in_fuel: 70,
    });
    ...
    const b3 = await Booking.create({
      ...
      deposit_paid: 30000,
      balance_due: 6000,
      actual_pickup_time: subDays(today, 22),
      actual_return_time: subDays(today, 20),
      check_out_mileage: 24000,
      check_in_mileage: 24500,
      check_out_fuel: 90,
      check_in_fuel: 50,
    });
    ...
    const b4 = await Booking.create({
      customer_id: c4.customer_id,
      vehicle_id: v15.vehicle_id,
      created_by: bookingOfficer.id,
      start_date: subDays(today, 18),
      end_date: subDays(today, 15),
      pickup_time: "14:00",
      return_time: "14:00",
      status: "completed",
      ...
      deposit_paid: 14000,
      balance_due: 0,
      actual_pickup_time: subDays(today, 18),
      actual_return_time: subDays(today, 15),
      check_out_mileage: 71000,
      check_in_mileage: 71800,
      check_out_fuel: 80,
      check_in_fuel: 45,
    });
    ...
    const b5 = await Booking.create({
      ...
      deposit_paid: 18000,
      balance_due: 7000,
      actual_pickup_time: subDays(today, 12),
      actual_return_time: subDays(today, 8),
      check_out_mileage: 41000,
      check_in_mileage: 41900,
      check_out_fuel: 100,
      check_in_fuel: 60,
    });
    ...
    const b6 = await Booking.create({
      ...
      deposit_paid: 6000,
      balance_due: 0,
      actual_pickup_time: subDays(today, 10),
      actual_return_time: subDays(today, 8),
      check_out_mileage: 139000,
      check_in_mileage: 139400,
      check_out_fuel: 70,
      check_in_fuel: 30,
    });
    ...
    const b7 = await Booking.create({
      ...
      deposit_paid: 8400,
      balance_due: 0,
      actual_pickup_time: subDays(today, 7),
      actual_return_time: subDays(today, 5),
      check_out_mileage: 47000,
      check_in_mileage: 47600,
      check_out_fuel: 85,
      check_in_fuel: 50,
    });
    ...
    const b8 = await Booking.create({
      ...
      deposit_paid: 5000,
      balance_due: 3400,
      actual_pickup_time: subDays(today, 1),
      check_out_mileage: 34590,
      check_out_fuel: 75,
    });
    ...
    const b10 = await Booking.create({
      ...
      deposit_paid: 15000,
      balance_due: 15000,
      actual_pickup_time: subDays(today, 2),
      check_out_mileage: 61000,
      check_out_fuel: 100,
    });
    ...
    const b12 = await Booking.create({
      customer_id: c7.customer_id,
      vehicle_id: v16.vehicle_id,
      created_by: bookingOfficer.id,
      start_date: subDays(today, 2),
      end_date: addDays(today, 1),
      pickup_time: "10:00",
    ...
    const b13 = await Booking.create({
      customer_id: c9.customer_id,
      vehicle_id: v7.vehicle_id,
      created_by: bookingOfficer.id,
    ...
    console.log(
      "✅ 16 Bookings created (7 completed, 5 checked-out, 3 confirmed, 1 cancelled)",
    );
    ...
    await Payment.create({
      ...
      amount: 6000,
      method: "mpesa",
      reference: "MPS-AH-001",
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Deposit via M-Pesa",
    });
    await Payment.create({
      booking_id: b2.booking_id,
      amount: 6000,
      method: "bank_transfer",
      reference: "BANK-AH-001",
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Final balance via bank transfer",
    });
    ...
    await Payment.create({
      ...
      amount: 20000,
      method: "mpesa",
      reference: "MPS-LA-001",
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Deposit for Mercedes C200",
    });
    await Payment.create({
      booking_id: b3.booking_id,
      amount: 10000,
      ...
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Partial payment on return",
    });

    // b4: Sarah Njeri — fully paid 14,000
    await Payment.create({
      booking_id: b4.booking_id,
      amount: 7000,
      method: "mpesa",
      reference: "MPS-SN-001",
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Deposit",
    });
    ...
    await Payment.create({
      booking_id: b5.booking_id,
      amount: 10000,
      method: "mpesa",
      reference: "MPS-BK-001",
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Deposit for Rav4 rental",
    });
    await Payment.create({
      booking_id: b5.booking_id,
      amount: 8000,
      ...
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Partial payment, KES 7,000 still owing",
    });
    ...
    await Payment.create({
      ...
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Full cash payment upfront",
    });

    // b7: Kevin Muthoni — fully paid 8,400
    await Payment.create({
      booking_id: b7.booking_id,
      amount: 5000,
      method: "mpesa",
      reference: "MPS-KM-001",
      status: "completed",
      recorded_by: bookingOfficer.id,
      notes: "Deposit",
    });
    ...
    await Maintenance.create({
      vehicle_id: v5.vehicle_id,
      service_date: subDays(today, 3),
      mileage: 95000,
      service_type: "full_service",
      description:
        "Full 100K service — engine oil, all filters, spark plugs, coolant flush, belt inspection",
      cost: 100000,
      provider: "AutoXpress Nairobi",
      provider_contact: "+254700111222",
      next_service_mileage: 105000,
      next_service_date: addDays(today, 180),
      is_scheduled: true,
      completed_by: mechanic.id,
      notes: "Transmission mount worn — schedule replacement next visit",
    });
    await Maintenance.create({
      vehicle_id: v23.vehicle_id,
      service_date: subDays(today, 1),
      mileage: 65000,
      service_type: "repair",
      description: "Hybrid battery diagnostics and coolant pump replacement",
      cost: 48000,
      provider: "EV Service Center",
      provider_contact: "+254711222333",
      next_service_mileage: 70000,
      next_service_date: addDays(today, 90),
      is_scheduled: false,
      completed_by: mechanic.id,
      notes: "Battery health at 82% — monitor closely",
    });
    await Maintenance.create({
      vehicle_id: v1.vehicle_id,
      service_date: subDays(today, 45),
      mileage: 76000,
      service_type: "oil_change",
      description: "Oil and filter change — 5W-30 synthetic",
      cost: 4500,
      provider: "Speedy Lube",
      provider_contact: "+254733444555",
      next_service_mileage: 81000,
      next_service_date: addDays(today, 60),
      is_scheduled: true,
      completed_by: mechanic.id,
    });
    await Maintenance.create({
      vehicle_id: v4.vehicle_id,
      service_date: subDays(today, 30),
      mileage: 41000,
      service_type: "tyre",
      description: "Replaced all 4 tyres — Michelin Primacy 4 225/65R17",
      cost: 52000,
      provider: "Tyre Centre Kenya",
      provider_contact: "+254722333444",
      next_service_mileage: 81000,
      is_scheduled: false,
      completed_by: mechanic.id,
    ...
    await Maintenance.create({
      vehicle_id: v2.vehicle_id,
      service_date: subDays(today, 60),
      mileage: 33000,
      service_type: "brake",
      description: "Front brake pads and disc replacement",
      cost: 18000,
      provider: "Brake Masters",
      provider_contact: "+254722333444",
      next_service_mileage: 53000,
      is_scheduled: false,
      completed_by: mechanic.id,
    });
    await Maintenance.create({
      vehicle_id: v8.vehicle_id,
      service_date: subDays(today, 15),
      mileage: 60000,
      service_type: "inspection",
      description:
        "Annual inspection — passed; minor oil seepage noted on valve cover",
      cost: 3000,
      provider: "NTSA Inspection Centre",
      provider_contact: "+254700555666",
      next_service_date: addDays(today, 350),
      is_scheduled: true,
      completed_by: mechanic.id,
    ...
    await Maintenance.create({
      vehicle_id: v20.vehicle_id,
      service_date: subDays(today, 5),
      mileage: 48000,
      service_type: "oil_change",
      description: "Oil and filter change — 5W-40",
      cost: 4000,
      provider: "Speedy Lube",
      provider_contact: "+254733444555",
      next_service_mileage: 53000,
    ...
    await MaintenanceSchedule.create({
      vehicle_id: v6.vehicle_id,
      service_type: "inspection",
      scheduled_date: addDays(today, 14),
      scheduled_mileage: 26000,
      priority: "medium",
      status: "pending",
      assigned_to: mechanic.id,
    });
    await MaintenanceSchedule.create({
      ...
      scheduled_mileage: 85000,
      priority: "high",
      status: "pending",
      assigned_to: mechanic.id,
    });
    await MaintenanceSchedule.create({
      vehicle_id: v22.vehicle_id,
      service_type: "full_service",
      scheduled_date: addDays(today, 21),
      scheduled_mileage: 25000,
      priority: "low",
      status: "pending",
      assigned_to: mechanic.id,
    });
    await MaintenanceSchedule.create({
      vehicle_id: v1.vehicle_id,
      service_type: "oil_change",
      scheduled_date: addDays(today, 60),
      scheduled_mileage: 81000,
      priority: "medium",
      status: "pending",
      assigned_to: mechanic.id,
    });
    ...
    await MaintenanceAlert.create({
      ...
      message:
        "Transmission mount replacement overdue — flagged during last service",
      due_date: subDays(today, 3),
      is_read: false,
    });
    await MaintenanceAlert.create({
      vehicle_id: v4.vehicle_id,
    ...
    await ActivityLog.create({
      user_id: bookingOfficer.id,
      username: "reception",
      role: "receptionist",
      action: "create",
      entity_type: "booking",
      entity_id: b9.booking_id,
      description:
        "Created booking RVMS-... for Brian Kiprono — Toyota Rav4 (KCC 345C)",
      created_at: subHours(today, 2),
    });
    await ActivityLog.create({
      user_id: bookingOfficer.id,
      username: "reception",
      ...
      action: "create",
      entity_type: "booking",
      entity_id: b11.booking_id,
      description: "Created booking for Lilian Akinyi — Honda Fit (KCH 890H)",
      created_at: subHours(today, 3),
    });
    await ActivityLog.create({
      user_id: bookingOfficer.id,
      username: "reception",
      ...
      entity_type: "booking",
      entity_id: b9.booking_id,
      description: "Checked out Toyota Rav4 (KCC 345C) to Brian Kiprono",
      created_at: subHours(today, 1),
    });
    await ActivityLog.create({
      user_id: bookingOfficer.id,
      username: "reception",
      ...
      entity_id: null,
      description:
        "Recorded KES 12,000 M-Pesa deposit for booking — Brian Kiprono",
      created_at: subHours(today, 2),
    });
    await ActivityLog.create({
      user_id: mechanic.id,
      ...
      entity_id: null,
      description:
        "Completed hybrid battery diagnostics on Mitsubishi Outlander Phev (KCU 101T)",
      created_at: subHours(today, 6),
    });
    await ActivityLog.create({
      user_id: fleetSup.id,
      username: "fleet",
      ...
      action: "update",
      entity_type: "vehicle",
      entity_id: v5.vehicle_id,
      description:
        "Moved Mitsubishi Outlander (KCD 456D) to maintenance status",
      created_at: subHours(today, 8),
    });
    await ActivityLog.create({
      user_id: bookingOfficer.id,
      username: "reception",
      ...
      entity_id: c10.customer_id,
      description: "Registered new customer Joyce Chebet (+254712345000)",
      created_at: subHours(today, 48),
    });
    await ActivityLog.create({
      user_id: admin.id,
      username: "admin",
      ...
      description: "Updated mechanic James Otieno account permissions",
      created_at: subHours(today, 72),
    });
    await ActivityLog.create({
      user_id: bookingOfficer.id,
      username: "reception",
      ...
      action: "return",
      entity_type: "booking",
      entity_id: b7.booking_id,
      description:
        "Returned VW Polo (KCR 770Q) from Kevin Muthoni — condition good",
      created_at: subHours(today, 50),
    });
    await ActivityLog.create({
      user_id: fleetSup.id,
      username: "fleet",
      ...
      entity_id: null,
      description:
        "Scheduled oil change for Toyota Rav4 (KCC 345C) at 45,000 km",
      created_at: subHours(today, 24),
    });
    ...
    const supplier1 = await Supplier.create({
      ...
      email: "james@autoparts.co.ke",
      phone: "+254711999888",
    });
    const supplier2 = await Supplier.create({
      name: "Tyre Centre Kenya",
      contact_person: "Mary Wambui",
      email: "mary@tyrecentre.co.ke",
      phone: "+254722333444",
    });
    ...
    await InventoryItem.create({
      ...
      description: "Air filter for Toyota models",
      item_type: "part",
      category_id: cat1.category_id,
      supplier_id: supplier1.supplier_id,
      universal: false,
      manufacturer: "Toyota",
      part_number: "AF-TY2020",
      unit: "piece",
      current_stock: 12,
      minimum_stock: 3,
      reorder_point: 6,
    ...
    await InventoryItem.create({
      ...
      description: "Front brake pads set — Brembo",
      item_type: "part",
    ...
    await InventoryItem.create({
      sku: "TYR-001",
      name: "Tyre 225/65R17 (Michelin)",
      description: "Michelin Primacy 4 all-season tyre",
      item_type: "part",
      category_id: cat3.category_id,
      supplier_id: supplier2.supplier_id,
      universal: false,
      manufacturer: "Michelin",
      part_number: "PRM4-22565R17",
      unit: "piece",
      current_stock: 16,
      minimum_stock: 4,
      reorder_point: 8,
    ...
    console.log(
      "  26 vehicles (17 available, 5 on-rent, 2 maintenance, 0 reserved)",
    );
    console.log("  10 customers");
    console.log(
      "  16 bookings (7 completed, 5 checked-out, 3 confirmed, 1 cancelled)",
    );
    ...
    console.log(
      "    → 1 completed booking (b3: Mercedes, KES 36K, balance 6K)",
    );
    console.log(
      "    → 1 active booking (b11: Honda Fit, KES 8.4K, balance 4.4K)",
    );
    console.log("");
